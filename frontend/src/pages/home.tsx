export const HomePage = () => {
  return (
    <main>
      {/* ============== HERO ============== */}
      <section class="relative overflow-hidden bg-agri-50 border-b-4 border-agri-700/80">
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 pb-16 sm:pb-24 grid lg:grid-cols-2 gap-12 items-center">
          <div class="fade-up">
            <span class="inline-flex items-center gap-2 bg-white border border-agri-300 text-agri-800 text-xs font-bold px-3 py-1.5 rounded-md shadow-soft">
              <i class="fa-solid fa-wheat-awn text-tech-600"></i> Smart India Hackathon Prototype
            </span>
            <h1 class="mt-5 font-display text-4xl sm:text-5xl font-bold leading-[1.12] text-agri-900">
              Catch crop problems <span class="text-eco-600">early</span> — before they cost you the harvest.
            </h1>
          ...
          <div class="relative fade-up">
            <div class="relative rounded-lg overflow-hidden shadow-soft border-2 border-white aspect-[4/3]">
              <img
              ...
              <div class="absolute bottom-4 left-4 right-4 card px-4 py-3 flex items-center gap-3">
                <div class="w-10 h-10 rounded-md bg-agri-100 flex items-center justify-center text-agri-700 shrink-0">
                ...
                <span class="status-chip bg-tech-100 text-tech-700 shrink-0">82% confident</span>
              </div>
            </div>
            <div class="absolute -top-5 -right-5 card px-4 py-2.5 hidden sm:flex items-center gap-2 fade-up">
              <span class="w-2.5 h-2.5 rounded-full bg-agri-600 pulse-ring"></span>
      ...
      <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="text-center max-w-2xl mx-auto mb-12">
          ...
          <h2 class="font-display text-3xl font-bold text-agri-900 mt-2">One photo. A complete health check.</h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-5 gap-4 relative">
          {[
            ...
            <a href={s.href} class="card card-hover p-5 text-center relative z-10">
              <div class={`w-12 h-12 mx-auto rounded-md bg-${s.color}-100 text-${s.color}-700 flex items-center justify-center text-lg mb-3`}>
      ...
      <section class="bg-agri-900 py-14 border-y-4 border-tech-500">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-6">
          <div class="text-white">
            <div class="w-10 h-10 rounded-md bg-agri-700 text-agri-200 flex items-center justify-center mb-4 border border-agri-600"><i class="fa-solid fa-code-compare"></i></div>
            <h3 class="font-display font-bold text-lg mb-1">Disease ≠ Pest — kept separate</h3>
            <p class="text-agri-300 text-sm leading-relaxed">Most tools bundle disease and pest signs into one guess. We assess them as two distinct tracks, plus a third for abiotic stress — so your treatment actually matches the real cause.</p>
          </div>
          <div class="text-white">
            <div class="w-10 h-10 rounded-md bg-agri-700 text-tech-300 flex items-center justify-center mb-4 border border-agri-600"><i class="fa-solid fa-magnifying-glass-chart"></i></div>
            <h3 class="font-display font-bold text-lg mb-1">Built for early, subtle signs</h3>
            <p class="text-agri-300 text-sm leading-relaxed">We're tuned to flag faint early indicators worth monitoring — not only advanced, obvious damage that's already too late to act on cheaply.</p>
          </div>
          <div class="text-white">
            <div class="w-10 h-10 rounded-md bg-agri-700 text-eco-300 flex items-center justify-center mb-4 border border-agri-600"><i class="fa-solid fa-gauge-high"></i></div>
            <h3 class="font-display font-bold text-lg mb-1">Honest confidence, always</h3>
            <p class="text-agri-300 text-sm leading-relaxed">No overconfident single label. Every result ships with a visible confidence score, and if it's low, we say so — and ask for a better photo instead of guessing.</p>
          </div>
        </div>
      </section>
      ...
      <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="text-center max-w-2xl mx-auto mb-12">
          ...
          <h2 class="font-display text-3xl font-bold text-agri-900 mt-2">Why early detection pays off</h2>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {[
            ...
            <div class="card card-hover p-6">
              <div class={`w-11 h-11 rounded-md bg-${s.color}-100 text-${s.color}-700 flex items-center justify-center text-lg mb-4`}>
                <i class={`fa-solid ${s.icon}`}></i>
              </div>
              <p class="font-bold text-gray-900">{s.title}</p>
      ...
      <section class="bg-eco-50 py-16 border-y border-eco-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="text-center max-w-2xl mx-auto mb-10">
            <span class="text-eco-700 font-bold text-sm tracking-wide uppercase">One platform, every role</span>
            <h2 class="font-display text-3xl font-bold text-agri-900 mt-2">Built for the whole ecosystem</h2>
          </div>
          <div class="grid md:grid-cols-3 gap-6">
            <a href="/scan" class="card card-hover p-6 border-t-4 border-agri-600">
              <div class="w-11 h-11 rounded-md bg-agri-100 text-agri-700 flex items-center justify-center text-lg mb-4"><i class="fa-solid fa-user"></i></div>
            ...
            <a href="/admin" class="card card-hover p-6 border-t-4 border-tech-500">
              <div class="w-11 h-11 rounded-md bg-tech-100 text-tech-700 flex items-center justify-center text-lg mb-4"><i class="fa-solid fa-user-shield"></i></div>
            ...
            <a href="/dealer" class="card card-hover p-6 border-t-4 border-eco-600">
              <div class="w-11 h-11 rounded-md bg-eco-100 text-eco-700 flex items-center justify-center text-lg mb-4"><i class="fa-solid fa-store"></i></div>
              ...
              <p class="text-sm font-semibold text-eco-700 mt-3">Open dealer view <i class="fa-solid fa-arrow-right ml-1 text-xs"></i></p>
            </a>
          </div>
        </div>
      </section>
      ...
      {/* ============== FINAL CTA ============== */}
      <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="rounded-lg bg-agri-800 border-2 border-tech-500 px-8 py-14 text-center relative overflow-hidden">
          <h2 class="font-display text-white text-3xl font-bold relative">Don't wait for damage you can already see.</h2>
          <p class="text-agri-200 mt-3 max-w-xl mx-auto relative">A 2-minute scan today can save your whole season. Try the full flow with realistic demo data right now.</p>
          <a href="/scan" class="btn-primary bg-tech-500 text-agri-900 hover:bg-tech-400 mt-7 inline-flex items-center gap-2 relative shadow-none">
